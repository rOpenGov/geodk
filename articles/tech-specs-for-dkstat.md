# Technical specification for intergration with {dkstat}
...
and in [the `{dkstat}`
documentation](https://ropengov.github.io/dkstat/articles/tech-specs-for-geodk.html).
[`vignette("tech-specs-for-dkstat", package = "geodk")`](https://ropengov.github.io/geodk/articles/tech-specs-for-dkstat.md).
...
[`geodk::geodk_enrich()`](https://ropengov.github.io/geodk/reference/geodk_enrich.md).
