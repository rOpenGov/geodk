...
dkstat::dst_get_all_data("laby01") |> 
  distinct(KOMGRP, .keep_all = TRUE) |> 
  tail()
```

```{r, eval = FALSE}
dkstat::dst_get_all_data("laby01") |> #class()
  geodk::geodk_enrich()
```
